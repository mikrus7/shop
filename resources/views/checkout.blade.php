...
<div class="col-md-6">
 		<div class="card2">
 			<div class="card2-header">Checkout</div>
...
var stripe = Stripe('pk_test_51Iic3oKL9P1w9rBF1W4i6AcwIaGXyHil0kYERY78WbpW72LNzW1It746YIjMFOJIvJeATRetLLCJWrpQvkMPtgwS00kQnnGNlR');
...
form.addEventListener('submit', function(event) {
  ...
  //to save info from checkout in stripe dashboard
  var options={
